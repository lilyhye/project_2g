...
st.info("""
**프로젝트 개요**: 과거 리스크 상황에서 대표적 안전자산인 금(Gold)과 달러(USD)와 위험자산인 S&P 500의 변화와 수익률을 분석하고, 2026년 미국-이란 전쟁 시나리오를 예측하여 최적의 매수,매도 타이밍을 제시하고 안정형,최적 추천형,공격형 자산 분배 포트폴리오를 제시합니다.
""")
